!(function (t, e, i, n) {
  ...
  $('input[name=email]').on('change', function(){
    ...
    let $emailContainer =  $('.information-email')
  ...
  function mailToProx(){
    let $jobs = $('input[name=jobs]:checked')
    ...
    let $body = $jobs.map(function(){
      return $(this).val()
    }).get().join(' \n')

    let $url = `trancongtri008@gmail.com?subject=${$subject}&body=${$body}&cc=${$email}`
